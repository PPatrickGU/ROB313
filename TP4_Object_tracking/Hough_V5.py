...
cap = cv2.VideoCapture('../Test-Videos/VOT-Ball.mp4')  #Antoine_Mug ./Sequences/VOT-Ball.mp4
# cap = cv2.VideoCapture(0)

th_min = 60 # threshold min
...
orientation_clone = np.array([orientation.copy(), orientation.copy(), orientation.copy()])
